...
*Versione 0.3 • 17 giugno 2026 • Bozza per validazione*

## Novità in questa versione (v0.3)
...
Questa prima versione è a uso privato e familiare, pensata per l'utilizzo simultaneo da più dispositivi (sincronizzazione tra telefoni).
...
| **FR-19** | L'utente può copiare i piatti e i commensali della settimana precedente nella settimana corrente. La lista della spesa non viene copiata: si rigenera dal piano. |
...
- Ordinamento della lista per reparto/categoria: richiederebbe un nuovo attributo di categoria sugli ingredienti, oggi assente.
- "Copia settimana precedente" quando la settimana corrente non è vuota: definire se sostituire, unire o bloccare.
