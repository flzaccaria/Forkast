...
| **FR-23** | La **gestione ingredienti** è una sezione principale dell'app (tab di navigazione, non più sotto Impostazioni). L'ordine dei tab segue il flusso dati: **Ingredienti · Piatti · Piano · Lista**. Il tab predefinito all'apertura è **Piano** (uso quotidiano). Il tab ingredienti elenca gli ingredienti **raggruppati per reparto** (FR-22, inclusa l'intestazione "Senza reparto") e permette di **filtrarli** (per reparto, unità, q.b., utilizzo), **ordinarli** (per nome, reparto, utilizzo) e **alternare** vista raggruppata ↔ piatta per individuare e unire i doppioni. Ricerca diacritics-insensitive. Nell'editor piatto, l'aggiunta ingrediente offre **autocomplete** dal catalogo (sottostringa + fuzzy diacritics-insensitive) con avviso anti-doppioni. Restano valide FR-16, FR-17, FR-18. |
